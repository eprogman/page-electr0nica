        ...
        <>
            ...
            (
                <section key={index} className="p-5 border-b-[20px]">
                    ...
                    {app.imagen1 && <img className="w-full max-w-xs h-auto inline pr-3" src={app.imagen1} alt="img" />}
                    {app.imagen2 && <img className="w-full max-w-xs h-auto inline pr-3" src={app.imagen2} alt="img" />}
                    {app.imagen3 && <img className="w-full max-w-xs h-auto inline pr-3" src={app.imagen3} alt="img" />}
                    {app.imagen4 && <img className="w-full max-w-xs h-auto inline pr-3" src={app.imagen4} alt="img" />}
