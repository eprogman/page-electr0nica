        ...
        <div>
            ...
            (
                <section key={index} className="p-5 border-b-[20px]">
                    <h2 className="text-xl lg:text-base uppercase font-bold ml-12 underline">{app.proyecto}</h2>
                    <div className="pb-3">
                        <iframe width="560" height="315" src={`https://www.youtube.com/embed/${app.codigo}`} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    </div>
